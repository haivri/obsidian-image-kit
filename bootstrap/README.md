...
The primary vault includes **Plugin Showcase/Install Image Kit 0.1.4 on mobile**. Sync that
...
```sh
node bootstrap/build-mobile-installer.mjs '/tmp/Install Image Kit 0.1.4 on mobile.md'
```
